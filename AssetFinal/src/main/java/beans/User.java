...
public class User {
	...
	public User(String userName, String userRole, int userTelephone, String userEmail, String userPassword) {
	...
	public User(int id, String userName, String userRole, int userTelephone, String userEmail, String userPassword) {
		this.userId = id;
		this.userName = userName;
		this.userRole = userRole;
		this.userTelephone = userTelephone;
